...
;----- Export ------------------------------------------------------------------
.export     clear_registers      ; Clear all PPU and CPU registers of the SNES
.export     clear_VRAM           ; Clear the complete VRAM to $00
.export     clear_CGRAM          ; Clear CG-RAM to $00 (black)
.export     clear_OAMRAM         ; Clear OAM-RAM to $ff (all sprites off screen)
;-------------------------------------------------------------------------------
...
@loop6:  stz $00, X
        ...
        rts
.endproc
;----- end of subroutine clear_registers ----------------------------------------
...
.proc   clear_OAMRAM
        ...
        rts
.endproc
;----- end of subroutine clear_OAMRAM -------------------------------------------
